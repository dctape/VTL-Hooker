...
define dso_local i32 @xdp_drop_func(%struct.xdp_md* nocapture readnone) #0 section "xdp_abort" !dbg !23 {
...
!3 = !DIFile(filename: "xdp_prog_kern.c", directory: "/home/fedora/xdp-tutorial/tracing01-xdp-simple")
!4 = !{!5}
...
!23 = distinct !DISubprogram(name: "xdp_drop_func", scope: !3, file: !3, line: 6, type: !24, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !37)
...
!39 = !DILocation(line: 6, column: 35, scope: !23)
