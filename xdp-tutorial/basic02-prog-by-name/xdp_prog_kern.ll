...
define dso_local i32 @xdp_pass_func(%struct.xdp_md* nocapture readnone) #0 section "xdp_pass" !dbg !23 {
  call void @llvm.dbg.value(metadata %struct.xdp_md* undef, metadata !38, metadata !DIExpression()), !dbg !39
  ret i32 2, !dbg !40
}

; Function Attrs: norecurse nounwind readnone
define dso_local i32 @xdp_drop_func(%struct.xdp_md* nocapture readnone) #0 section "xdp_drop" !dbg !41 {
...
!3 = !DIFile(filename: "xdp_prog_kern.c", directory: "/home/fedora/xdp-tutorial/basic02-prog-by-name")
!4 = !{!5}
!5 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "xdp_action", file: !6, line: 2845, baseType: !7, size: 32, elements: !8)
!6 = !DIFile(filename: "../headers/linux/bpf.h", directory: "/home/fedora/xdp-tutorial/basic02-prog-by-name")
...
!22 = !{!"clang version 8.0.0 (Fedora 8.0.0-1.fc30)"}
!23 = distinct !DISubprogram(name: "xdp_pass_func", scope: !3, file: !3, line: 18, type: !24, scopeLine: 19, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !37)
...
!39 = !DILocation(line: 18, column: 35, scope: !23)
!40 = !DILocation(line: 20, column: 2, scope: !23)
!41 = distinct !DISubprogram(name: "xdp_drop_func", scope: !3, file: !3, line: 24, type: !24, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !42)
!42 = !{!43}
!43 = !DILocalVariable(name: "ctx", arg: 1, scope: !41, file: !3, line: 24, type: !27)
!44 = !DILocation(line: 24, column: 35, scope: !41)
