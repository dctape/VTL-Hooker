...
@xdp_stats_map = dso_local global %struct.bpf_map_def { i32 6, i32 4, i32 4, i32 64, i32 0, i32 0, i32 0 }, section "maps", align 4, !dbg !15
...
define dso_local i32 @xdp_sock_prog(%struct.xdp_md* nocapture readonly) #0 section "xdp_sock" !dbg !49 {
...
; <label>:20:                                     ; preds = %14, %9, %17
  %21 = phi i32 [ %19, %17 ], [ 2, %9 ], [ 2, %14 ], !dbg !93
...
!3 = !DIFile(filename: "af_xdp_kern.c", directory: "/home/fedora/xdp-tutorial/advanced03-AF_XDP")
!4 = !{!5}
...
!17 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "bpf_map_def", file: !18, line: 210, size: 224, elements: !19)
!18 = !DIFile(filename: "../headers/bpf_helpers.h", directory: "/home/fedora/xdp-tutorial/advanced03-AF_XDP")
!19 = !{!20, !21, !22, !23, !24, !25, !26}
!20 = !DIDerivedType(tag: DW_TAG_member, name: "type", scope: !17, file: !18, line: 211, baseType: !7, size: 32)
!21 = !DIDerivedType(tag: DW_TAG_member, name: "key_size", scope: !17, file: !18, line: 212, baseType: !7, size: 32, offset: 32)
!22 = !DIDerivedType(tag: DW_TAG_member, name: "value_size", scope: !17, file: !18, line: 213, baseType: !7, size: 32, offset: 64)
!23 = !DIDerivedType(tag: DW_TAG_member, name: "max_entries", scope: !17, file: !18, line: 214, baseType: !7, size: 32, offset: 96)
!24 = !DIDerivedType(tag: DW_TAG_member, name: "map_flags", scope: !17, file: !18, line: 215, baseType: !7, size: 32, offset: 128)
!25 = !DIDerivedType(tag: DW_TAG_member, name: "inner_map_idx", scope: !17, file: !18, line: 216, baseType: !7, size: 32, offset: 160)
!26 = !DIDerivedType(tag: DW_TAG_member, name: "numa_node", scope: !17, file: !18, line: 217, baseType: !7, size: 32, offset: 192)
...
!34 = distinct !DIGlobalVariable(name: "bpf_map_lookup_elem", scope: !2, file: !18, line: 20, type: !35, isLocal: true, isDefinition: true)
!35 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !36, size: 64)
!36 = !DISubroutineType(types: !37)
!37 = !{!38, !38, !38}
!38 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!39 = !DIGlobalVariableExpression(var: !40, expr: !DIExpression())
!40 = distinct !DIGlobalVariable(name: "bpf_redirect_map", scope: !2, file: !18, line: 57, type: !41, isLocal: true, isDefinition: true)
...
!48 = !{!"clang version 8.0.0 (Fedora 8.0.0-1.fc30)"}
!49 = distinct !DISubprogram(name: "xdp_sock_prog", scope: !3, file: !3, line: 22, type: !50, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !62)
...
!56 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u32", file: !57, line: 27, baseType: !7)
!57 = !DIFile(filename: "/usr/include/asm-generic/int-ll64.h", directory: "")
...
!94 = !DILocation(line: 41, column: 1, scope: !49)
