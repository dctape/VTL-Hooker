...
define dso_local i32 @xdp_prog_simple(%struct.xdp_md* nocapture readnone) #0 section "xdp" !dbg !23 {
...
!3 = !DIFile(filename: "xdp_pass_kern.c", directory: "/home/fedora/xdp-tutorial/basic01-xdp-pass")
!4 = !{!5}
!5 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "xdp_action", file: !6, line: 2845, baseType: !7, size: 32, elements: !8)
!6 = !DIFile(filename: "../headers/linux/bpf.h", directory: "/home/fedora/xdp-tutorial/basic01-xdp-pass")
...
!23 = distinct !DISubprogram(name: "xdp_prog_simple", scope: !3, file: !3, line: 6, type: !24, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !37)
...
!39 = !DILocation(line: 6, column: 37, scope: !23)
