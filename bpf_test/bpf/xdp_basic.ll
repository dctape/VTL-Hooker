; ModuleID = 'xdp_basic.c'
source_filename = "xdp_basic.c"
...
!1 = distinct !DIGlobalVariable(name: "_license", scope: !2, file: !3, line: 10, type: !14, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "xdp_basic.c", directory: "/home/ubuntu/Hooker/bpf_test/bpf")
!4 = !{!5}
...
!22 = distinct !DISubprogram(name: "xdp_prog_simple", scope: !3, file: !3, line: 5, type: !23, isLocal: false, isDefinition: true, scopeLine: 6, flags: DIFlagPrototyped, isOptimized: true, unit: !2, variables: !37)
...
!31 = !DIFile(filename: "/usr/include/asm-generic/int-ll64.h", directory: "/home/ubuntu/Hooker/bpf_test/bpf")
...
!39 = !DILocation(line: 5, column: 37, scope: !22)
!40 = !DILocation(line: 7, column: 2, scope: !22)
